...
ogr2ogr -f "ESRI Shapefile" -overwrite qgis/layers/Berlin/1690/landuse.shp maps/1690/landuse_1690.geojson
ogr2ogr -f "ESRI Shapefile" -overwrite qgis/layers/Berlin/1690/lines.shp maps/1690/lines_1690.geojson
ogr2ogr -f "ESRI Shapefile" -overwrite qgis/layers/Berlin/1690/polygons.shp maps/1690/polygons_1690.geojson